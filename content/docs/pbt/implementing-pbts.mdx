...
```json
{
  ...
  "description": "1 of 24 Pioneer Centre Seconds – Water, an artifact of *Azuki x Moser: Elements of Time*. Channeling Azuki's intuition, Water carves through even the hardest steel.",
